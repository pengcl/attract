<template name="page-form">
	<view class="page-form">
		<view class="page-form__wrapper">
			<form class="form">
				<uni-list>
					<uni-list-item :class="'control_' + key" v-if="item.type !== 'hidden'" v-for="(item, key, index) in form.controls" class="form-control list-item">
						<template v-if="item.type !== 'chips'" v-slot:header>
						...
						<template v-slot:body>
							...
							<view v-if="item.type === 'chips'" class="list-item-body">
								<view class="chips-lable">{{item.label}} <view v-if="item.required" class="required">*</view></view>
								<view class="chips-options">
									<view class="chips-grids">
										<view v-for="(option,index) in item.options" class="chips-grid">
											<view :data-target="key" :data-index="index" @click="bindChipChange" :class="index === item.index ? 'curr' : ''" class="chip-box">{{option.label}}</view>
										</view>
									</view>
								</view>
							</view>
